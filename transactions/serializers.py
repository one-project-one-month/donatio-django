...
class UpdateTransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transaction
        fields = ["id", "organization", "donor", "event", "amount", "type", "status", "review_required", "attachments", "uploaded_attachments"]
        read_only_fields = ["id", "organization", "donor", "event", "amount", "type", "attachments"]
    ...
    def update(self, instance, validated_data):
        ...
        with db_transaction.atomic():
            ...
            #Update only when the value is different from the current value
